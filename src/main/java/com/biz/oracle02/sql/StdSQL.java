...
public class StdSQL {
	...
	= " INSERT INTO tbl_student(st_num,st_name,st_grade,st_tel) VALUES (#{st_num},#{st_name},#{st_grade},#{st_tel}) ";
	
	public static final String STD_ALL = " SELECT * FROM tbl_student ORDER BY st_num ";
	...
	= " UPDATE tbl_student SET st_name = #{st_name}, st_grade = #{st_grade}, st_tel = #{st_tel} WHERE st_num = #{st_num} ";
